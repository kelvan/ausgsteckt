...
from .views import (
    MainMapView, BuschenschankDetailView, BuschenschankAPIDetailView, PublicBuschenschankGeoJsonView, RegionListView,
...
urlpatterns = [
    ...
    url(
        r'^data.geojson$',
        cache_page(60 * 15)(PublicBuschenschankGeoJsonView.as_view()), name='buschenschank.geojson'
    ),
